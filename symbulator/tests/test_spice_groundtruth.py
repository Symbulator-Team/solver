...
CASES = [
    ...
    # #314: the paired forms. The transformer's primary sits between
    ...
    "e1,1,0,10:r0,1,2,1:t1,[2,0],[3,0],[2,1]:r1,3,0,100",
    "e1,1,0,10:r0,1,2,3:z,[2,4],[3,5],[100,10,20,50]:r4,4,0,2:rl,3,5,200:"
    "r5,5,0,9",
    "e1,1,0,10:r0,1,2,3:y,[2,4],[3,5],[0.02,-0.01,-0.01,0.02]:r4,4,0,2:"
    "rl,3,5,200:r5,5,0,9",
    "e1,1,0,10:r0,1,2,3:h,[2,4],[3,5],[100,0.1,-2,0.01]:r4,4,0,2:rl,3,5,200:"
    "r5,5,0,9",
    "e1,1,0,10:r0,1,2,3:g,[2,4],[3,5],[0.01,0.1,2,50]:r4,4,0,2:rl,3,5,200:"
    "r5,5,0,9",
    "e1,1,0,10:r0,1,2,3:a,[2,4],[3,5],[2,100,0.01,1.5]:r4,4,0,2:rl,3,5,200:"
    "r5,5,0,9",
    "e1,1,0,10:r0,1,2,3:b,[2,4],[3,5],[2,100,0.01,1.5]:r4,4,0,2:rl,3,5,200:"
    "r5,5,0,9",
    "e1,1,0,10:z,[1,0],[2,0],[100,10,20,50]:rl,2,0,200",
]
